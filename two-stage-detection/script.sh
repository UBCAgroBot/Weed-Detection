...
#SBATCH --mail-user=rohanshukla344@gmail.com
#SBATCH --mem=12G
#SBATCH --nodes=1
#SBATCH --ntasks=1
...
/home/shukla06/miniconda3/envs/two-stage-detection/bin/python /scratch/st-sielmann-1/agrobot/Weed-Detection/two-stage-detection/detectron2_train.py
